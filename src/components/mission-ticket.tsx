  ...
  return (
    <Card className="flex flex-col overflow-hidden transition-all hover:shadow-lg hover:-translate-y-1">
      <CardHeader className="flex-row items-center justify-between p-4 bg-muted">
        ...
        <div className="text-xs font-semibold text-muted-foreground">BOARDING PASS</div>
      </CardHeader>
      <CardContent className="p-4 flex-1">
        <div className="flex justify-between items-center">
            ...
            <div>
                 <p className="text-xs text-muted-foreground text-right">FROM</p>
        ...
        <div className="space-y-3 text-sm">
            ...
            {mission.prerequisites.length > 0 && (
                <div className="text-xs">
                    <span className="font-semibold">Prerequisites:</span> {mission.prerequisites.join(", ")}
                </div>
            )}
        </div>
      </CardContent>
      <CardFooter className="p-4 bg-muted">
        <Button className="w-full" asChild>
          <Link href={`/missions/${mission.stack}/${mission.id}`}>Start Mission</Link>
        </Button>
      </CardFooter>
    </Card>
  )
