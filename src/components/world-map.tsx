              ...
              <div className="material-glass rounded-xl p-3 border border-white/10 hover:bg-white/15 transition-all duration-300 card-3d">
                ...
                <div className="flex flex-wrap gap-1">
                  {countries.map((country, index) => (
                    <div 
                      key={country.id} 
                      className="flex items-center gap-1 px-2 py-1 rounded-lg hover:bg-white/10 transition-all duration-300 cursor-pointer group animate-micro-bounce"
                      style={{
                        animationDelay: `${index * 100}ms`
                      }}
                    >
                      <span className="text-sm group-hover:scale-110 transition-transform duration-200">{country.flag}</span>
                      <span className="text-blue-100 font-medium group-hover:text-white transition-colors text-xs">
